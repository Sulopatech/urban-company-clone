...
export class AddCustomeFieldCustomerAvatar1719986026667 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `customer` ADD CONSTRAINT `FK_14e5b31a6af5523c8b1f2f68dae` FOREIGN KEY (`customFieldsProfilepicid`) REFERENCES `asset`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
   }
